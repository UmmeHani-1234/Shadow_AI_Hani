    ...
    <div className="grid gap-6">
      <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Regional intelligence</p>
            <h1 className="text-[20px] font-semibold text-slate-900 mt-2">Overview for {currentHospital?.region}</h1>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {nearbyRegions.map((region) => (
                <div key={region.region} className="rounded-3xl border border-slate-200 bg-white p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="text-[13.5px] font-medium text-slate-900">{region.region}</p>
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-3xl bg-white p-4">
                  ...
                  <div className="mt-2 text-[18px] font-semibold text-slate-900">Increasing</div>
                </div>
                <div className="rounded-3xl bg-white p-4">
                  <div className="text-[12px] text-slate-500">Nearby alerts</div>
                  <div className="mt-2 text-[18px] font-semibold text-slate-900">4</div>
                </div>
                <div className="rounded-3xl bg-white p-4">
                  <div className="text-[12px] text-slate-500">Environmental risk</div>
                  <div className="mt-2 text-[18px] font-semibold text-slate-900">Moderate</div>
                </div>
                <div className="rounded-3xl bg-white p-4">
                  <div className="text-[12px] text-slate-500">Reporting cadence</div>
                  <div className="mt-2 text-[18px] font-semibold text-slate-900">Daily</div>
                </div>
              </div>
            </div>
          </div>
